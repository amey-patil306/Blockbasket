...
const DEMO_USERS = {
  farmer: { id: '1', name: 'John Farmer', role: 'farmer' as const },
  distributor: { id: '2', name: 'Mike Distributor', role: 'distributor' as const },
  admin: { id: '3', name: 'Admin User', role: 'admin' as const },
};
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (formData.username && formData.password) {
        ...
        const demoUser = DEMO_USERS[formData.role as keyof typeof DEMO_USERS];
        login(demoUser);
